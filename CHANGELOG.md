...
- 修复 CLI 未能自动加载 atlas 文件的错误
- 增加 GitHub 资源面板

## v0.16.33

- 关于对话框增加检查更新按钮和版本跳转链接
- 增加网络代理和 GitHub 访问令牌首选项
- 重构资源库相关模块
...
- 允许模型加载时 atlas/png 文件部分缺失
- 增加禁用 atlas 加载首选项
- query 命令去除 atlas 文件依赖
...
- 列表右键菜单增加聚焦/居中命令, 支持快捷键操作
- 增加模型导入时避免重叠首选项
- 插槽名筛选不区分大小写
- 程序菜单增加 wiki 跳转命令
- 文本框支持回车提交
- 命令行工具增加物理效果选项
- 增强命令行工具 warmup 参数负数取值功能
- 移除发布文件中的 pdb 文件
- 修复某些模型包围盒 NaN 计算错误
...
- 首选项增加选中模型高亮背景选项
- 修复 CLI 工具预热物理效果无效问题
- 修复导出时自动时长未同步按速度因子缩放问题
- 移动程序配置文件和状态文件至程序根目录 data 文件夹下
