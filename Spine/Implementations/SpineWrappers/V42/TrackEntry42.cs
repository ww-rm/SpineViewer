...
{
    internal sealed class TrackEntry42(TrackEntry innerObject, AnimationState42 animationState, SpineObjectData42 data): ITrackEntry
    {
        private readonly TrackEntry _o = innerObject;
        private readonly AnimationState42 _animationState = animationState;
